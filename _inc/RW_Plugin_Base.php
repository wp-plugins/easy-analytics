...
abstract class RW_Plugin_Base {
	 ...
	 */
	abstract function rw_plugin_install();
	
	/**
	 * Create the settings page meta boxes
	 */
	abstract function rw_plugin_create_meta_boxes();
	
	/**
	 * Settings save method
	 */
	abstract function rw_plugin_save_settings();
